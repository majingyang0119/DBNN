...
#define Yalpha _ml->template fpfield<3>(_iml)
#define Yalpha_columnindex 3
#define Yvdep _ml->template fpfield<4>(_iml)
#define Yvdep_columnindex 4
#define Yconcdep _ml->template fpfield<5>(_iml)
#define Yconcdep_columnindex 5
#define tauY _ml->template fpfield<6>(_iml)
#define tauY_columnindex 6
#define Y_inf _ml->template fpfield<7>(_iml)
#define Y_inf_columnindex 7
#define Y _ml->template fpfield<8>(_iml)
#define Y_columnindex 8
#define cai _ml->template fpfield<9>(_iml)
#define cai_columnindex 9
#define DY _ml->template fpfield<10>(_iml)
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"Yalpha"} /* 3 */,
                                       _nrn_mechanism_field<double>{"Yvdep"} /* 4 */,
                                       _nrn_mechanism_field<double>{"Yconcdep"} /* 5 */,
                                       _nrn_mechanism_field<double>{"tauY"} /* 6 */,
                                       _nrn_mechanism_field<double>{"Y_inf"} /* 7 */,
                                       _nrn_mechanism_field<double>{"Y"} /* 8 */,
                                       _nrn_mechanism_field<double>{"cai"} /* 9 */,
                                       _nrn_mechanism_field<double>{"DY"} /* 10 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 Kca3_1 /home/mjy/project/bilinear_network/purkinje/mod_files/Kca31.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/mjy/project/bilinear_network/purkinje/mod_files/Kca31.mod";
