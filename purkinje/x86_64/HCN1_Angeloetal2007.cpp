...
#define eh _ml->template fpfield<7>(_iml)
#define eh_columnindex 7
#define v_inf_half _ml->template fpfield<8>(_iml)
#define v_inf_half_columnindex 8
#define v_tau_half1 _ml->template fpfield<9>(_iml)
#define v_tau_half1_columnindex 9
#define v_tau_half2 _ml->template fpfield<10>(_iml)
#define v_tau_half2_columnindex 10
...
#define ljp ljp_HCN1
 double ljp = 9.3;
#define rec_temp rec_temp_HCN1
 double rec_temp = 23;
#define v_tau_k2 v_tau_k2_HCN1
 double v_tau_k2 = 7.14;
#define v_tau_k1 v_tau_k1_HCN1
 double v_tau_k1 = -22;
#define v_tau_half2_noljp v_tau_half2_noljp_HCN1
 double v_tau_half2_noljp = -68;
#define v_tau_half1_noljp v_tau_half1_noljp_HCN1
 double v_tau_half1_noljp = -68;
#define v_tau_const v_tau_const_HCN1
 double v_tau_const = 0.0018;
#define v_inf_k v_inf_k_HCN1
 double v_inf_k = 9.67;
#define v_inf_half_noljp v_inf_half_noljp_HCN1
 ...
 {"rec_temp_HCN1", "deg"},
 {"ljp_HCN1", "mV"},
 {"v_inf_half_noljp_HCN1", "mV"},
 {"v_inf_k_HCN1", "mV"},
 {"v_tau_const_HCN1", "1"},
 {"v_tau_half1_noljp_HCN1", "mV"},
 {"v_tau_half2_noljp_HCN1", "mV"},
 {"v_tau_k1_HCN1", "mv"},
 {"v_tau_k2_HCN1", "mv"},
 {"gbar_HCN1", "mho/cm2"},
 {"ratetau_HCN1", "ms"},
 ...
 {"rec_temp_HCN1", &rec_temp_HCN1},
 {"ljp_HCN1", &ljp_HCN1},
 {"v_inf_half_noljp_HCN1", &v_inf_half_noljp_HCN1},
 {"v_inf_k_HCN1", &v_inf_k_HCN1},
 {"v_tau_const_HCN1", &v_tau_const_HCN1},
 {"v_tau_half1_noljp_HCN1", &v_tau_half1_noljp_HCN1},
 {"v_tau_half2_noljp_HCN1", &v_tau_half2_noljp_HCN1},
 {"v_tau_k1_HCN1", &v_tau_k1_HCN1},
 {"v_tau_k2_HCN1", &v_tau_k2_HCN1},
 {0, 0}
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _HCN1_Angeloetal2007_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("h", 1.0);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"eh"} /* 7 */,
                                       _nrn_mechanism_field<double>{"v_inf_half"} /* 8 */,
                                       _nrn_mechanism_field<double>{"v_tau_half1"} /* 9 */,
                                       _nrn_mechanism_field<double>{"v_tau_half2"} /* 10 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 HCN1 /home/mjy/project/bilinear_network/purkinje/mod_files/HCN1_Angeloetal2007.mod\n");
...
static void _hoc_rate(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rate_HCN1. Requires prior call to setdata_HCN1 and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/mjy/project/bilinear_network/purkinje/mod_files/HCN1_Angeloetal2007.mod";
