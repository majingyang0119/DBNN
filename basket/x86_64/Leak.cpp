 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_prop_size(_mechtype, 5, 0);
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 Leak /home/mjy/project/bilinear_network/basket/mod_files/Leak.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/mjy/project/bilinear_network/basket/mod_files/Leak.mod";
