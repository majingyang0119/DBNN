...
#define nrn_init _nrn_init__Nav1_1
#define _nrn_initial _nrn_initial__Nav1_1
#define nrn_cur _nrn_cur__Nav1_1
#define _nrn_current _nrn_current__Nav1_1
#define nrn_jacob _nrn_jacob__Nav1_1
#define nrn_state _nrn_state__Nav1_1
#define _net_receive _net_receive__Nav1_1 
#define activation activation__Nav1_1 
#define rates rates__Nav1_1 
...
#define igate _ml->template fpfield<3>(_iml)
#define igate_columnindex 3
#define g _ml->template fpfield<4>(_iml)
#define g_columnindex 4
#define nc _ml->template fpfield<5>(_iml)
#define nc_columnindex 5
...
#define qt _ml->template fpfield<20>(_iml)
#define qt_columnindex 20
#define alfac _ml->template fpfield<21>(_iml)
#define alfac_columnindex 21
#define btfac _ml->template fpfield<22>(_iml)
#define btfac_columnindex 22
#define f01 _ml->template fpfield<23>(_iml)
#define f01_columnindex 23
#define f02 _ml->template fpfield<24>(_iml)
#define f02_columnindex 24
#define f03 _ml->template fpfield<25>(_iml)
#define f03_columnindex 25
#define f04 _ml->template fpfield<26>(_iml)
#define f04_columnindex 26
#define f0O _ml->template fpfield<27>(_iml)
#define f0O_columnindex 27
#define fip _ml->template fpfield<28>(_iml)
#define fip_columnindex 28
#define f11 _ml->template fpfield<29>(_iml)
#define f11_columnindex 29
#define f12 _ml->template fpfield<30>(_iml)
#define f12_columnindex 30
#define f13 _ml->template fpfield<31>(_iml)
#define f13_columnindex 31
#define f14 _ml->template fpfield<32>(_iml)
#define f14_columnindex 32
#define f1n _ml->template fpfield<33>(_iml)
#define f1n_columnindex 33
#define fi1 _ml->template fpfield<34>(_iml)
#define fi1_columnindex 34
#define fi2 _ml->template fpfield<35>(_iml)
#define fi2_columnindex 35
#define fi3 _ml->template fpfield<36>(_iml)
#define fi3_columnindex 36
#define fi4 _ml->template fpfield<37>(_iml)
#define fi4_columnindex 37
#define fi5 _ml->template fpfield<38>(_iml)
#define fi5_columnindex 38
#define fin _ml->template fpfield<39>(_iml)
#define fin_columnindex 39
#define b01 _ml->template fpfield<40>(_iml)
#define b01_columnindex 40
#define b02 _ml->template fpfield<41>(_iml)
#define b02_columnindex 41
#define b03 _ml->template fpfield<42>(_iml)
#define b03_columnindex 42
#define b04 _ml->template fpfield<43>(_iml)
#define b04_columnindex 43
#define b0O _ml->template fpfield<44>(_iml)
#define b0O_columnindex 44
#define bip _ml->template fpfield<45>(_iml)
#define bip_columnindex 45
#define b11 _ml->template fpfield<46>(_iml)
#define b11_columnindex 46
#define b12 _ml->template fpfield<47>(_iml)
#define b12_columnindex 47
#define b13 _ml->template fpfield<48>(_iml)
#define b13_columnindex 48
#define b14 _ml->template fpfield<49>(_iml)
#define b14_columnindex 49
#define b1n _ml->template fpfield<50>(_iml)
#define b1n_columnindex 50
#define bi1 _ml->template fpfield<51>(_iml)
#define bi1_columnindex 51
#define bi2 _ml->template fpfield<52>(_iml)
#define bi2_columnindex 52
#define bi3 _ml->template fpfield<53>(_iml)
#define bi3_columnindex 53
#define bi4 _ml->template fpfield<54>(_iml)
#define bi4_columnindex 54
#define bi5 _ml->template fpfield<55>(_iml)
#define bi5_columnindex 55
#define bin _ml->template fpfield<56>(_iml)
#define bin_columnindex 56
#define DC1 _ml->template fpfield<57>(_iml)
#define DC1_columnindex 57
#define DC2 _ml->template fpfield<58>(_iml)
#define DC2_columnindex 58
#define DC3 _ml->template fpfield<59>(_iml)
#define DC3_columnindex 59
#define DC4 _ml->template fpfield<60>(_iml)
#define DC4_columnindex 60
#define DC5 _ml->template fpfield<61>(_iml)
#define DC5_columnindex 61
#define DI1 _ml->template fpfield<62>(_iml)
#define DI1_columnindex 62
#define DI2 _ml->template fpfield<63>(_iml)
#define DI2_columnindex 63
#define DI3 _ml->template fpfield<64>(_iml)
#define DI3_columnindex 64
#define DI4 _ml->template fpfield<65>(_iml)
#define DI4_columnindex 65
#define DI5 _ml->template fpfield<66>(_iml)
#define DI5_columnindex 66
#define DO _ml->template fpfield<67>(_iml)
#define DO_columnindex 67
#define DB _ml->template fpfield<68>(_iml)
#define DB_columnindex 68
#define DI6 _ml->template fpfield<69>(_iml)
#define DI6_columnindex 69
#define v _ml->template fpfield<70>(_iml)
#define v_columnindex 70
#define _g _ml->template fpfield<71>(_iml)
...
#define _ion_dinadv *(_ml->dptr_field<2>(_iml))
 ...
 static void _hoc_gateFlip(void);
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_Nav1_1", _hoc_setdata},
 {"gateFlip_Nav1_1", _hoc_gateFlip},
 {"rates_Nav1_1", _hoc_rates},
 {0, 0}
};
 
/* Direct Python call wrappers to density mechanism functions.*/
 static double _npy_gateFlip(Prop*);
 static double _npy_rates(Prop*);
 
static NPyDirectMechFunc npy_direct_func_proc[] = {
 {"gateFlip", _npy_gateFlip},
 {"rates", _npy_rates},
 {0, 0}
};
#define gateFlip gateFlip_Nav1_1
 extern double gateFlip( _internalthreadargsproto_ );
 /* declare global and static user variables */
 #define gind 0
 #define _gth 0
#define Coff Coff_Nav1_1
 double Coff = 0.5;
#define Con Con_Nav1_1
 double Con = 0.005;
#define Ooff Ooff_Nav1_1
 double Ooff = 0.005;
#define Oon Oon_Nav1_1
 double Oon = 2.3;
#define alpha alpha_Nav1_1
 double alpha = 150;
#define beta beta_Nav1_1
 double beta = 3;
#define delta delta_Nav1_1
 double delta = 40;
#define epsilon epsilon_Nav1_1
 double epsilon = 1e-12;
#define gamma gamma_Nav1_1
 double gamma = 150;
#define gunit gunit_Nav1_1
 double gunit = 15;
#define gateCurrent gateCurrent_Nav1_1
...
#define x1 x1_Nav1_1
 double x1 = 20;
#define zeta zeta_Nav1_1
 double zeta = 0.03;
#define zgate zgate_Nav1_1
 double zgate = 2.5435;
 ...
 {"gateCurrent_Nav1_1", &gateCurrent_Nav1_1},
 {"zgate_Nav1_1", &zgate_Nav1_1},
 {"gunit_Nav1_1", &gunit_Nav1_1},
 {"Con_Nav1_1", &Con_Nav1_1},
 {"Coff_Nav1_1", &Coff_Nav1_1},
 {"Oon_Nav1_1", &Oon_Nav1_1},
 {"Ooff_Nav1_1", &Ooff_Nav1_1},
 {"alpha_Nav1_1", &alpha_Nav1_1},
 {"beta_Nav1_1", &beta_Nav1_1},
 {"gamma_Nav1_1", &gamma_Nav1_1},
 {"delta_Nav1_1", &delta_Nav1_1},
 {"epsilon_Nav1_1", &epsilon_Nav1_1},
 {"zeta_Nav1_1", &zeta_Nav1_1},
 {"x1_Nav1_1", &x1_Nav1_1},
 {"x2_Nav1_1", &x2_Nav1_1},
 {"x3_Nav1_1", &x3_Nav1_1},
 {"x4_Nav1_1", &x4_Nav1_1},
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"igate"} /* 3 */,
                                       _nrn_mechanism_field<double>{"g"} /* 4 */,
                                       _nrn_mechanism_field<double>{"nc"} /* 5 */,
                                       ...
                                       _nrn_mechanism_field<double>{"qt"} /* 20 */,
                                       _nrn_mechanism_field<double>{"alfac"} /* 21 */,
                                       _nrn_mechanism_field<double>{"btfac"} /* 22 */,
                                       _nrn_mechanism_field<double>{"f01"} /* 23 */,
                                       _nrn_mechanism_field<double>{"f02"} /* 24 */,
                                       _nrn_mechanism_field<double>{"f03"} /* 25 */,
                                       _nrn_mechanism_field<double>{"f04"} /* 26 */,
                                       _nrn_mechanism_field<double>{"f0O"} /* 27 */,
                                       _nrn_mechanism_field<double>{"fip"} /* 28 */,
                                       _nrn_mechanism_field<double>{"f11"} /* 29 */,
                                       _nrn_mechanism_field<double>{"f12"} /* 30 */,
                                       _nrn_mechanism_field<double>{"f13"} /* 31 */,
                                       _nrn_mechanism_field<double>{"f14"} /* 32 */,
                                       _nrn_mechanism_field<double>{"f1n"} /* 33 */,
                                       _nrn_mechanism_field<double>{"fi1"} /* 34 */,
                                       _nrn_mechanism_field<double>{"fi2"} /* 35 */,
                                       _nrn_mechanism_field<double>{"fi3"} /* 36 */,
                                       _nrn_mechanism_field<double>{"fi4"} /* 37 */,
                                       _nrn_mechanism_field<double>{"fi5"} /* 38 */,
                                       _nrn_mechanism_field<double>{"fin"} /* 39 */,
                                       _nrn_mechanism_field<double>{"b01"} /* 40 */,
                                       _nrn_mechanism_field<double>{"b02"} /* 41 */,
                                       _nrn_mechanism_field<double>{"b03"} /* 42 */,
                                       _nrn_mechanism_field<double>{"b04"} /* 43 */,
                                       _nrn_mechanism_field<double>{"b0O"} /* 44 */,
                                       _nrn_mechanism_field<double>{"bip"} /* 45 */,
                                       _nrn_mechanism_field<double>{"b11"} /* 46 */,
                                       _nrn_mechanism_field<double>{"b12"} /* 47 */,
                                       _nrn_mechanism_field<double>{"b13"} /* 48 */,
                                       _nrn_mechanism_field<double>{"b14"} /* 49 */,
                                       _nrn_mechanism_field<double>{"b1n"} /* 50 */,
                                       _nrn_mechanism_field<double>{"bi1"} /* 51 */,
                                       _nrn_mechanism_field<double>{"bi2"} /* 52 */,
                                       _nrn_mechanism_field<double>{"bi3"} /* 53 */,
                                       _nrn_mechanism_field<double>{"bi4"} /* 54 */,
                                       _nrn_mechanism_field<double>{"bi5"} /* 55 */,
                                       _nrn_mechanism_field<double>{"bin"} /* 56 */,
                                       _nrn_mechanism_field<double>{"DC1"} /* 57 */,
                                       _nrn_mechanism_field<double>{"DC2"} /* 58 */,
                                       _nrn_mechanism_field<double>{"DC3"} /* 59 */,
                                       _nrn_mechanism_field<double>{"DC4"} /* 60 */,
                                       _nrn_mechanism_field<double>{"DC5"} /* 61 */,
                                       _nrn_mechanism_field<double>{"DI1"} /* 62 */,
                                       _nrn_mechanism_field<double>{"DI2"} /* 63 */,
                                       _nrn_mechanism_field<double>{"DI3"} /* 64 */,
                                       _nrn_mechanism_field<double>{"DI4"} /* 65 */,
                                       _nrn_mechanism_field<double>{"DI5"} /* 66 */,
                                       _nrn_mechanism_field<double>{"DO"} /* 67 */,
                                       _nrn_mechanism_field<double>{"DB"} /* 68 */,
                                       _nrn_mechanism_field<double>{"DI6"} /* 69 */,
                                       _nrn_mechanism_field<double>{"v"} /* 70 */,
                                       _nrn_mechanism_field<double>{"_g"} /* 71 */,
  ...
  hoc_register_prop_size(_mechtype, 72, 4);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 Nav1_1 /home/mjy/project/bilinear_network/basket/mod_files/Nav1_1.mod\n");
...
static int _reset;
static const char *modelname = "Non-resurgent sodium channel in Purkinje cells";
...
double gateFlip ( _internalthreadargsproto_ ) {
   double _lgateFlip;
 _lgateFlip = f01 * C1 + ( f02 - b01 ) * C2 + ( f03 - b02 ) * C3 + ( f04 - b03 ) * C4 - b04 * C5 ;
   _lgateFlip = _lgateFlip + f11 * I1 + ( f12 - b11 ) * I2 + ( f13 - b12 ) * I3 + ( f14 - b13 ) * I4 - b14 * I5 ;
...
if (gind != 0 && _thread != nullptr) { _globals = _thread[_gth].get<double*>(); }
_nt = nrn_threads;
 _r =  gateFlip ( _threadargs_ );
 hoc_retpushx(_r);
}
 
static double _npy_gateFlip(Prop* _prop) {
    double _r{0.0};
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
 _nrn_mechanism_cache_instance _ml_real{_prop};
auto* const _ml = &_ml_real;
...
{ {
   g = gbar * O ;
   ina = g * ( v - ena ) ;
   igate = nc * ( 1e6 ) * e0 * zgate * gateFlip ( _threadargs_ ) ;
   if ( gateCurrent  != 0.0 ) {
     i = igate ;
     }
   }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/mjy/project/bilinear_network/basket/mod_files/Nav1_1.mod";
