...
#define nrn_init _nrn_init__HCN1_PC
#define _nrn_initial _nrn_initial__HCN1_PC
#define nrn_cur _nrn_cur__HCN1_PC
#define _nrn_current _nrn_current__HCN1_PC
#define nrn_jacob _nrn_jacob__HCN1_PC
#define nrn_state _nrn_state__HCN1_PC
#define _net_receive _net_receive__HCN1_PC 
#define rate rate__HCN1_PC 
#define states states__HCN1_PC 
...
#define eh _ml->template fpfield<8>(_iml)
#define eh_columnindex 8
#define v_inf_half _ml->template fpfield<9>(_iml)
#define v_inf_half_columnindex 9
#define v_tau_half1 _ml->template fpfield<10>(_iml)
#define v_tau_half1_columnindex 10
#define v_tau_half2 _ml->template fpfield<11>(_iml)
#define v_tau_half2_columnindex 11
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_HCN1_PC", _hoc_setdata},
 {"rate_HCN1_PC", _hoc_rate},
 {0, 0}
};
...
static NPyDirectMechFunc npy_direct_func_proc[] = {
 ...
 #define gind 0
 #define _gth 0
#define ljp ljp_HCN1_PC
 double ljp = 9.3;
#define rec_temp rec_temp_HCN1_PC
 double rec_temp = 23;
#define v_tau_k2 v_tau_k2_HCN1_PC
 double v_tau_k2 = 7.14;
#define v_tau_k1 v_tau_k1_HCN1_PC
 double v_tau_k1 = -22;
#define v_tau_half2_noljp v_tau_half2_noljp_HCN1_PC
 double v_tau_half2_noljp = -68;
#define v_tau_half1_noljp v_tau_half1_noljp_HCN1_PC
 double v_tau_half1_noljp = -68;
#define v_tau_const v_tau_const_HCN1_PC
 double v_tau_const = 0.0018;
#define v_inf_k v_inf_k_HCN1_PC
 double v_inf_k = 9.67;
#define v_inf_half_noljp v_inf_half_noljp_HCN1_PC
 ...
 {"rec_temp_HCN1_PC", "deg"},
 {"ljp_HCN1_PC", "mV"},
 {"v_inf_half_noljp_HCN1_PC", "mV"},
 {"v_inf_k_HCN1_PC", "mV"},
 {"v_tau_const_HCN1_PC", "1"},
 {"v_tau_half1_noljp_HCN1_PC", "mV"},
 {"v_tau_half2_noljp_HCN1_PC", "mV"},
 {"v_tau_k1_HCN1_PC", "mv"},
 {"v_tau_k2_HCN1_PC", "mv"},
 {"gbar_HCN1_PC", "mho/cm2"},
 {"ratetau_HCN1_PC", "ms"},
 {"ih_HCN1_PC", "mA/cm2"},
 {0, 0}
};
 ...
 {"rec_temp_HCN1_PC", &rec_temp_HCN1_PC},
 {"ljp_HCN1_PC", &ljp_HCN1_PC},
 {"v_inf_half_noljp_HCN1_PC", &v_inf_half_noljp_HCN1_PC},
 {"v_inf_k_HCN1_PC", &v_inf_k_HCN1_PC},
 {"v_tau_const_HCN1_PC", &v_tau_const_HCN1_PC},
 {"v_tau_half1_noljp_HCN1_PC", &v_tau_half1_noljp_HCN1_PC},
 {"v_tau_half2_noljp_HCN1_PC", &v_tau_half2_noljp_HCN1_PC},
 {"v_tau_k1_HCN1_PC", &v_tau_k1_HCN1_PC},
 {"v_tau_k2_HCN1_PC", &v_tau_k2_HCN1_PC},
 {0, 0}
};
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"ratetau"} /* 1 */,
                                       _nrn_mechanism_field<double>{"g_equiv"} /* 2 */,
                                       _nrn_mechanism_field<double>{"ih"} /* 3 */,
                                       _nrn_mechanism_field<double>{"hinf"} /* 4 */,
                                       _nrn_mechanism_field<double>{"tauh"} /* 5 */,
                                       _nrn_mechanism_field<double>{"h"} /* 6 */,
                                       _nrn_mechanism_field<double>{"Dh"} /* 7 */,
                                       _nrn_mechanism_field<double>{"eh"} /* 8 */,
                                       _nrn_mechanism_field<double>{"v_inf_half"} /* 9 */,
                                       _nrn_mechanism_field<double>{"v_tau_half1"} /* 10 */,
                                       _nrn_mechanism_field<double>{"v_tau_half2"} /* 11 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 HCN1_PC /home/mjy/project/bilinear_network/basket/mod_files/HCN1_PC.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
 static double q10 = 3;
static int _reset;
static const char *modelname = "I-h HCN1 channel from Kamilla Angelo, Michael London,Soren R. Christensen, and Michael Hausser 2007 J. of Neurosci.";
...
static void _hoc_rate(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rate_HCN1_PC. Requires prior call to setdata_HCN1_PC and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/mjy/project/bilinear_network/basket/mod_files/HCN1_PC.mod";
