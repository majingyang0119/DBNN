...
#define vhalfm _ml->template fpfield<1>(_iml)
#define vhalfm_columnindex 1
#define cvm _ml->template fpfield<2>(_iml)
#define cvm_columnindex 2
#define vshift _ml->template fpfield<3>(_iml)
#define vshift_columnindex 3
#define pcabar _ml->template fpfield<4>(_iml)
#define pcabar_columnindex 4
  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 5, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 19);
 	...
 	vhalfm = _parm_default[1]; /* -29.458 */
 	cvm = _parm_default[2]; /* 8.429 */
 	vshift = _parm_default[3]; /* 0 */
 	pcabar = _parm_default[4]; /* 0.00022 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 19);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"vhalfm"} /* 1 */,
                                       _nrn_mechanism_field<double>{"cvm"} /* 2 */,
                                       _nrn_mechanism_field<double>{"vshift"} /* 3 */,
                                       _nrn_mechanism_field<double>{"pcabar"} /* 4 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 Cav2_1 /home/mjy/project/bilinear_network/basket/mod_files/Cav2_1.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/mjy/project/bilinear_network/basket/mod_files/Cav2_1.mod";
  ...
  "    RANGE pcabar, ica, gk, vhalfm, cvm, vshift, taum, minf, g_equiv\n"
  "}\n"
  "\n"
  "UNITS {\n"
  "    (mV) = (millivolt)\n"
