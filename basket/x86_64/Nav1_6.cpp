...
#define C3 _ml->template fpfield<5>(_iml)
#define C3_columnindex 5
#define C4 _ml->template fpfield<6>(_iml)
#define C4_columnindex 6
#define C5 _ml->template fpfield<7>(_iml)
#define C5_columnindex 7
#define I1 _ml->template fpfield<8>(_iml)
#define I1_columnindex 8
#define I2 _ml->template fpfield<9>(_iml)
#define I2_columnindex 9
#define I3 _ml->template fpfield<10>(_iml)
#define I3_columnindex 10
#define I4 _ml->template fpfield<11>(_iml)
#define I4_columnindex 11
#define I5 _ml->template fpfield<12>(_iml)
#define I5_columnindex 12
#define O _ml->template fpfield<13>(_iml)
#define O_columnindex 13
#define B _ml->template fpfield<14>(_iml)
#define B_columnindex 14
#define I6 _ml->template fpfield<15>(_iml)
#define I6_columnindex 15
#define alfac _ml->template fpfield<16>(_iml)
#define alfac_columnindex 16
#define btfac _ml->template fpfield<17>(_iml)
#define btfac_columnindex 17
#define f01 _ml->template fpfield<18>(_iml)
#define f01_columnindex 18
#define f02 _ml->template fpfield<19>(_iml)
#define f02_columnindex 19
#define f03 _ml->template fpfield<20>(_iml)
#define f03_columnindex 20
#define f04 _ml->template fpfield<21>(_iml)
#define f04_columnindex 21
#define f0O _ml->template fpfield<22>(_iml)
#define f0O_columnindex 22
#define fip _ml->template fpfield<23>(_iml)
#define fip_columnindex 23
#define f11 _ml->template fpfield<24>(_iml)
#define f11_columnindex 24
#define f12 _ml->template fpfield<25>(_iml)
#define f12_columnindex 25
#define f13 _ml->template fpfield<26>(_iml)
#define f13_columnindex 26
#define f14 _ml->template fpfield<27>(_iml)
#define f14_columnindex 27
#define f1n _ml->template fpfield<28>(_iml)
#define f1n_columnindex 28
#define fi1 _ml->template fpfield<29>(_iml)
#define fi1_columnindex 29
#define fi2 _ml->template fpfield<30>(_iml)
#define fi2_columnindex 30
#define fi3 _ml->template fpfield<31>(_iml)
#define fi3_columnindex 31
#define fi4 _ml->template fpfield<32>(_iml)
#define fi4_columnindex 32
#define fi5 _ml->template fpfield<33>(_iml)
#define fi5_columnindex 33
#define fin _ml->template fpfield<34>(_iml)
#define fin_columnindex 34
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"C3"} /* 5 */,
                                       _nrn_mechanism_field<double>{"C4"} /* 6 */,
                                       _nrn_mechanism_field<double>{"C5"} /* 7 */,
                                       _nrn_mechanism_field<double>{"I1"} /* 8 */,
                                       _nrn_mechanism_field<double>{"I2"} /* 9 */,
                                       _nrn_mechanism_field<double>{"I3"} /* 10 */,
                                       _nrn_mechanism_field<double>{"I4"} /* 11 */,
                                       _nrn_mechanism_field<double>{"I5"} /* 12 */,
                                       _nrn_mechanism_field<double>{"O"} /* 13 */,
                                       _nrn_mechanism_field<double>{"B"} /* 14 */,
                                       _nrn_mechanism_field<double>{"I6"} /* 15 */,
                                       _nrn_mechanism_field<double>{"alfac"} /* 16 */,
                                       _nrn_mechanism_field<double>{"btfac"} /* 17 */,
                                       _nrn_mechanism_field<double>{"f01"} /* 18 */,
                                       _nrn_mechanism_field<double>{"f02"} /* 19 */,
                                       _nrn_mechanism_field<double>{"f03"} /* 20 */,
                                       _nrn_mechanism_field<double>{"f04"} /* 21 */,
                                       _nrn_mechanism_field<double>{"f0O"} /* 22 */,
                                       _nrn_mechanism_field<double>{"fip"} /* 23 */,
                                       _nrn_mechanism_field<double>{"f11"} /* 24 */,
                                       _nrn_mechanism_field<double>{"f12"} /* 25 */,
                                       _nrn_mechanism_field<double>{"f13"} /* 26 */,
                                       _nrn_mechanism_field<double>{"f14"} /* 27 */,
                                       _nrn_mechanism_field<double>{"f1n"} /* 28 */,
                                       _nrn_mechanism_field<double>{"fi1"} /* 29 */,
                                       _nrn_mechanism_field<double>{"fi2"} /* 30 */,
                                       _nrn_mechanism_field<double>{"fi3"} /* 31 */,
                                       _nrn_mechanism_field<double>{"fi4"} /* 32 */,
                                       _nrn_mechanism_field<double>{"fi5"} /* 33 */,
                                       _nrn_mechanism_field<double>{"fin"} /* 34 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 Nav1_6 /home/mjy/project/bilinear_network/basket/mod_files/Nav1_6.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/mjy/project/bilinear_network/basket/mod_files/Nav1_6.mod";
