...
#define nrn_init _nrn_init__Cav3_2
#define _nrn_initial _nrn_initial__Cav3_2
#define nrn_cur _nrn_cur__Cav3_2
#define _nrn_current _nrn_current__Cav3_2
#define nrn_jacob _nrn_jacob__Cav3_2
#define nrn_state _nrn_state__Cav3_2
#define _net_receive _net_receive__Cav3_2 
#define castate castate__Cav3_2 
#define evaluate_fct evaluate_fct__Cav3_2 
...
#define t _nt->_t
#define dt _nt->_dt
#define g_equiv _ml->template fpfield<0>(_iml)
#define g_equiv_columnindex 0
#define gcabar _ml->template fpfield<1>(_iml)
#define gcabar_columnindex 1
#define shift _ml->template fpfield<2>(_iml)
...
#define carev _ml->template fpfield<15>(_iml)
#define carev_columnindex 15
#define phi_m _ml->template fpfield<16>(_iml)
#define phi_m_columnindex 16
#define phi_h _ml->template fpfield<17>(_iml)
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_Cav3_2", _hoc_setdata},
 {"evaluate_fct_Cav3_2", _hoc_evaluate_fct},
 {0, 0}
};
  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 5, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 20);
 	...
 	g_equiv = _parm_default[0]; /* 0 */
 	gcabar = _parm_default[1]; /* 0.0008 */
 	shift = _parm_default[2]; /* 0 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 20);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       _nrn_mechanism_field<double>{"g_equiv"} /* 0 */,
                                       _nrn_mechanism_field<double>{"gcabar"} /* 1 */,
                                       _nrn_mechanism_field<double>{"shift"} /* 2 */,
                                       ...
                                       _nrn_mechanism_field<double>{"carev"} /* 15 */,
                                       _nrn_mechanism_field<double>{"phi_m"} /* 16 */,
                                       _nrn_mechanism_field<double>{"phi_h"} /* 17 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 Cav3_2 /home/mjy/project/bilinear_network/basket/mod_files/Cav3_2.mod\n");
...
static int  evaluate_fct ( _internalthreadargsprotocomma_ double _lv ) {
   m_inf = 1.0 / ( 1.0 + exp ( - ( _lv + shift + 54.8 ) / 7.4 ) ) ;
   h_inf = 1.0 / ( 1.0 + exp ( ( _lv + shift + 85.5 ) / 7.18 ) ) ;
   tau_m = ( 1.9 + 1.0 / ( exp ( ( _lv + shift + 37.0 ) / 11.9 ) + exp ( - ( _lv + shift + 131.6 ) / 21.0 ) ) ) / phi_m ;
   tau_h = 13.7 + ( 1942.0 + exp ( ( _lv + shift + 164.0 ) / 9.2 ) ) / ( 1.0 + exp ( ( _lv + shift + 89.3 ) / 3.7 ) ) / phi_h ;
    return 0; }
...
static void _hoc_evaluate_fct(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for evaluate_fct_Cav3_2. Requires prior call to setdata_Cav3_2 and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void initmodel(_internalthreadargsproto_) {
  ...
  m = m0;
 {
   phi_m = pow( 5.0 , ( 12.0 / 10.0 ) ) ;
   phi_h = pow( 3.0 , ( 12.0 / 10.0 ) ) ;
   evaluate_fct ( _threadargscomma_ v ) ;
   m = m_inf ;
   h = h_inf ;
   }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/mjy/project/bilinear_network/basket/mod_files/Cav3_2.mod";
  ...
  "	RANGE gcabar, m_inf, tau_m, h_inf, tau_h, shift, i,ica, g_equiv\n"
  "}\n"
  "\n"
  "UNITS {\n"
  "	(molar) = (1/liter)\n"
