...
#define i_AMPA _ml->template fpfield<11>(_iml)
#define i_AMPA_columnindex 11
#define i_NMDA _ml->template fpfield<12>(_iml)
#define i_NMDA_columnindex 12
#define g_AMPA _ml->template fpfield<13>(_iml)
#define g_AMPA_columnindex 13
#define g_NMDA _ml->template fpfield<14>(_iml)
#define g_NMDA_columnindex 14
#define weight_NMDA _ml->template fpfield<15>(_iml)
#define weight_NMDA_columnindex 15
#define A_AMPA _ml->template fpfield<16>(_iml)
#define A_AMPA_columnindex 16
#define B_AMPA _ml->template fpfield<17>(_iml)
#define B_AMPA_columnindex 17
#define A_NMDA _ml->template fpfield<18>(_iml)
#define A_NMDA_columnindex 18
#define B_NMDA _ml->template fpfield<19>(_iml)
#define B_NMDA_columnindex 19
#define factor_AMPA _ml->template fpfield<20>(_iml)
#define factor_AMPA_columnindex 20
#define factor_NMDA _ml->template fpfield<21>(_iml)
#define factor_NMDA_columnindex 21
#define DA_AMPA _ml->template fpfield<22>(_iml)
#define DA_AMPA_columnindex 22
#define DB_AMPA _ml->template fpfield<23>(_iml)
#define DB_AMPA_columnindex 23
#define DA_NMDA _ml->template fpfield<24>(_iml)
#define DA_NMDA_columnindex 24
#define DB_NMDA _ml->template fpfield<25>(_iml)
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _ProbAMPANMDA2_reg() {
	int _vectorized = 0;
  _initlists();
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"i_AMPA"} /* 11 */,
                                       _nrn_mechanism_field<double>{"i_NMDA"} /* 12 */,
                                       _nrn_mechanism_field<double>{"g_AMPA"} /* 13 */,
                                       _nrn_mechanism_field<double>{"g_NMDA"} /* 14 */,
                                       _nrn_mechanism_field<double>{"weight_NMDA"} /* 15 */,
                                       _nrn_mechanism_field<double>{"A_AMPA"} /* 16 */,
                                       _nrn_mechanism_field<double>{"B_AMPA"} /* 17 */,
                                       _nrn_mechanism_field<double>{"A_NMDA"} /* 18 */,
                                       _nrn_mechanism_field<double>{"B_NMDA"} /* 19 */,
                                       _nrn_mechanism_field<double>{"factor_AMPA"} /* 20 */,
                                       _nrn_mechanism_field<double>{"factor_NMDA"} /* 21 */,
                                       _nrn_mechanism_field<double>{"DA_AMPA"} /* 22 */,
                                       _nrn_mechanism_field<double>{"DB_AMPA"} /* 23 */,
                                       _nrn_mechanism_field<double>{"DA_NMDA"} /* 24 */,
                                       _nrn_mechanism_field<double>{"DB_NMDA"} /* 25 */,
 ...
 pnt_receive_size[_mechtype] = 7;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 ProbAMPANMDA2 /home/mjy/project/bilinear_network/2021Neuron/L5PC/mods/ProbAMPANMDA2.mod\n");
 ...
 v=_v;
{
 { error =  state();
 if(error){
  std_cerr_stream << "at line 105 in file ProbAMPANMDA2.mod:\n\n";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/mjy/project/bilinear_network/2021Neuron/L5PC/mods/ProbAMPANMDA2.mod";
