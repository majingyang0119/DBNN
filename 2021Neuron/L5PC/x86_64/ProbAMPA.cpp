...
#define DA_AMPA _ml->template fpfield<23>(_iml)
#define DA_AMPA_columnindex 23
#define DB_AMPA _ml->template fpfield<24>(_iml)
#define DB_AMPA_columnindex 24
#define DA_NMDA _ml->template fpfield<25>(_iml)
#define DA_NMDA_columnindex 25
#define DB_NMDA _ml->template fpfield<26>(_iml)
#define DB_NMDA_columnindex 26
#define _g _ml->template fpfield<27>(_iml)
#define _g_columnindex 27
#define _tsav _ml->template fpfield<28>(_iml)
  ...
  if (nrn_point_prop_) {
   ...
   _ppvar = nrn_prop_datum_alloc(_mechtype, 4, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 29);
 	...
 	tau_r_NMDA = _parm_default[2]; /* 1e-08 */
 	tau_d_NMDA = _parm_default[3]; /* 2e-08 */
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"DA_AMPA"} /* 23 */,
                                       _nrn_mechanism_field<double>{"DB_AMPA"} /* 24 */,
                                       _nrn_mechanism_field<double>{"DA_NMDA"} /* 25 */,
                                       _nrn_mechanism_field<double>{"DB_NMDA"} /* 26 */,
                                       _nrn_mechanism_field<double>{"_g"} /* 27 */,
                                       _nrn_mechanism_field<double>{"_tsav"} /* 28 */,
 ...
 pnt_receive_size[_mechtype] = 7;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 ProbAMPA /home/mjy/project/bilinear_network/2021Neuron/L5PC/mods/ProbAMPA.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   ...
   g_NMDA = 0.0 * gmax * ( B_NMDA - A_NMDA ) * mggate ;
   i_AMPA = g_AMPA * ( v - e ) ;
   i_NMDA = g_NMDA * ( v - e ) ;
   i = i_AMPA + i_NMDA ;
   }
 ...
 v=_v;
{
 { error =  state();
 if(error){
  std_cerr_stream << "at line 106 in file ProbAMPA.mod:\n\n";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/mjy/project/bilinear_network/2021Neuron/L5PC/mods/ProbAMPA.mod";
  ...
  "        tau_r_NMDA = 0.00000001   (ms) : dual-exponential conductance profile\n"
  "        tau_d_NMDA = 0.00000002     (ms) : IMPORTANT: tau_r < tau_d\n"
  ...
  "	g_NMDA = 0*gmax*(B_NMDA-A_NMDA) * mggate :compute time varying conductance as the difference of state variables B_NMDA and A_NMDA and mggate kinetics\n"
