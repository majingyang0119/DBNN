...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 10, "ca_ion");
 	...
 	ivoc_help("help ?1 spike /home/mjy/project/Bilinear_Network/sheasbyfohlmeister1999/x86_64/spike.mod\n");
 ...
 v=_v;
{
  ...
  cao = _ion_cao;
 { error =  states();
 if(error){fprintf(stderr,"at line 90 in file spike.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 }   }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mjy/project/Bilinear_Network/sheasbyfohlmeister1999/spike.mod";
static const char* nmodl_file_text = 
